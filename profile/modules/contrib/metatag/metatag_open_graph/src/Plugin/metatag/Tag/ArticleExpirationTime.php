 ...
 *   description = @Translation("The date this content will expire, with an sync time value. Needs to be in <a href='http://en.wikipedia.org/wiki/ISO_8601'>ISO 8601</a> format."),
